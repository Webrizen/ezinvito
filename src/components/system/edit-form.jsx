...
export default function EditForm({ event }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            router.push(`/dashboard/invitations/${updatedEvent.customSlug || updatedEvent._id}`);
        } catch (err) {
                        ...
                        <div className="space-y-6">
                            ...
                            <div className='relative'>
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-blue-100 dark:bg-blue-50/10 dark:text-blue-50 cursor-pointer text-blue-700 rounded-full hover:bg-blue-200 transition-colors absolute bottom-4 right-2 backdrop-blur-3xl"
