...
const Sidebar = ({ children }) => {
  ...
  return (
    <div className="flex h-[92dvh] overflow-hidden">
      ...
      <aside 
        data-sidebar 
        className={`fixed h-full py-3 overflow-hidden lg:static w-11/12 max-w-[18rem] md:w-72 transition-all ${
      ...
      >
        <nav className="flex-1 pt-6">
          <ul className="text-zinc-700 dark:text-zinc-300 space-y-3">
            <li className="relative before:absolute before:-left-4 before:w-1.5 before:h-4/5 before:rounded-r-md before:top-1/2 before:-translate-y-1/2 before:bg-blue-600">
              <Link href="/dashboard" className="flex items-center px-4 py-2.5 gap-x-3 text-blue-600 bg-zinc-50 dark:bg-zinc-900/80 rounded-md">
            ...
            <li>
              <Link href="/dashboard/invitations" className="flex items-center px-4 py-2.5 gap-x-3">
            ...
            <li>
              <Link href="/dashboard/calender" className="flex items-center px-4 py-2.5 gap-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            <li>
              <Link href="/dashboard/guests" className="flex items-center px-4 py-2.5 gap-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            <li>
              <Link href="/dashboard/qr" className="flex items-center px-4 py-2.5 gap-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
        ...
        <div>
          <div className="flex flex-col gap-y-2 text-zinc-700 dark:text-zinc-300">
            <Link href="/contact" className="flex items-center px-4 py-2.5 gap-x-3">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
