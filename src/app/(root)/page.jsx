...
export default function Home() {
  return (
    <>
      <AuroraBackground>
        <section className="w-full min-h-screen md:p-10 p-5 relative">
          <Spotlight
            className="-top-40 left-0 md:-top-20 md:left-60"
            fill="white"
          />
          <div className="container mx-auto w-full h-full dark:text-inherit text-zinc-50 rounded-xl">
            <div className="w-full space-y-6 py-24 px-4 md:text-center text-left flex flex-col items-center justify-center h-full">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight md:max-w-5xl animated-gradient-text bg-clip-text text-transparent">
